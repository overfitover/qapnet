...
class DatasetBuilder(object):
    ...
    def load_dataset_from_config(dataset_config_path):
        ...
        with open(dataset_config_path, 'r') as f:
            ...
            # print(dataset_config)    # rpn_cars.config
    ...
    def build_kitti_dataset(base_cfg,
        ...
        # print(cfg_copy)  # 对rpn_cars.config的独立复制
...
def main():
    # DatasetBuilder.build_kitti_dataset(DatasetBuilder.KITTI_TRAINVAL)

    car_dataset_config_path = avod.root_dir() + \
                              '/configs/mb_preprocessing/rpn_cars.config'
    # print(car_dataset_config_path)
