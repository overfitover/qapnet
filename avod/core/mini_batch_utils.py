...
class MiniBatchUtils:
    def __init__(self, dataset):
        ...
        self._area_extents = self.kitti_utils_config.area_extents    # [-40.0, 40.0, -5.0, 3.0, 0.0, 70.0]
        self._anchor_strides = np.reshape(
            self.kitti_utils_config.anchor_strides, (-1, 2))         # [0.5, 0.5]
    ...
    def preprocess_rpn_mini_batches(self, indices):
        ...
        mini_batch_preprocessor = \
            MiniBatchPreprocessor(self._dataset,
                                  ...
                                  self._density_threshold,    # 有一个点就计算anchor
