            ...
            with tf.variable_scope(scope, 'bev_vgg', [inputs]) as sc:
                ...
                with slim.arg_scope([slim.conv2d, slim.max_pool2d],
                    ...
                    net = slim.repeat(inputs,
                                      vgg_config.vgg_conv1[0],                  # 2
                                      slim.conv2d,
                                      vgg_config.vgg_conv1[1],                  # 32
                                      [3, 3],
                    ...
                    net = slim.repeat(net,
                                      vgg_config.vgg_conv2[0],                  # 2
                                      slim.conv2d,
                                      vgg_config.vgg_conv2[1],                  # 64
                                      [3, 3],
                                      normalizer_fn=slim.batch_norm,
                                      normalizer_params={
                                          'is_training': is_training},
                    ...
                    net = slim.repeat(net,
                                      vgg_config.vgg_conv3[0],                  # 3
                                      slim.conv2d,
                                      vgg_config.vgg_conv3[1],                  # 128
                                      [3, 3],
                                      normalizer_fn=slim.batch_norm,
                                      normalizer_params={
                                          'is_training': is_training},
                    ...
                    net = slim.repeat(net,
                                      vgg_config.vgg_conv4[0],                  # 3
                                      slim.conv2d,
                                      vgg_config.vgg_conv4[1],                  # 256
                                      [3, 3],
                                      normalizer_fn=slim.batch_norm,
                                      normalizer_params={
                                          'is_training': is_training},
                ...
                with tf.variable_scope('upsampling'):
                    ...
                    feature_maps_out = tf.image.resize_bilinear(
                        net, upsampled_shape)                           # resize到upsampled_shape尺寸
