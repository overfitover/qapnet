            ...
            with tf.variable_scope(scope, 'bev_vgg_pyr', [inputs]) as sc:
                ...
                with slim.arg_scope([slim.conv2d, slim.max_pool2d],
                    ...
                    conv1 = slim.repeat(conv1,
                                        ...
                                        scope='conv1_1')
                    # 0
                    conv1 = self.squeeze_excitation_layer(conv1, 1, 'first')
                    ...
                    conv2 = slim.repeat(conv2,
                                        ...
                                        scope='conv2_2')
                    # 1
                    conv2 = self.squeeze_excitation_layer(conv2, 1, 'first')
                    ...
                    conv3 = slim.repeat(pool2,
                                        ...
                                        scope='conv3')
                    # 2
                    conv3 = self.squeeze_excitation_layer(conv3, 1, 'first')
                    ...
                    conv4 = slim.repeat(pool3,
                                        ...
                                        scope='conv4')
                    # 3
                    # conv4 = self.squeeze_excitation_layer(conv4, 1, 'first')
