...
def train(model, train_config):
    ...
    #############################
    max_iterations = train_config.max_iterations              # 120000
    summary_interval = train_config.summary_interval          # 10
    checkpoint_interval = \
        train_config.checkpoint_interval                      # 1000
    max_checkpoints = train_config.max_checkpoints_to_keep    # 10000

    paths_config = model_config.paths_config
    # checkpoint_dir: "/home/yxk/project/aa_demo_graduate/qapNet/avod/data/outputs/pyramid_cars_example/checkpoints"
    # logdir: "/home/yxk/project/aa_demo_graduate/qapNet/avod/data/outputs/pyramid_cars_example/logs/"
    # pred_dir: "/home/yxk/project/aa_demo_graduate/qapNet/avod/data/outputs/pyramid_cars_example/predictions"
    ...
    if not train_config.overwrite_checkpoints:
        trainer_utils.load_checkpoints(checkpoint_dir,
                                       saver)             # load latest checkpoint if available
    ...
    for step in range(global_step, max_iterations + 1):
        ...
        """
        {<tf.Tensor 'bev_input/bev_input_pl:0' shape=(700, 800, 6) dtype=float32>: 
        <tf.Tensor 'img_input/img_input_pl:0' shape=(?, ?, 3) dtype=float32>: 
        <tf.Tensor 'pl_labels/label_anchors_pl:0' shape=(?, 6) dtype=float32>: 
        <tf.Tensor 'pl_labels/label_boxes_3d_pl:0' shape=(?, 7) dtype=float32>: 
        <tf.Tensor 'pl_labels/label_classes_pl:0' shape=(?,) dtype=float32>: 
        <tf.Tensor 'pl_anchors/anchors_pl:0' shape=(?, 6) dtype=float32>: 
        <tf.Tensor 'pl_anchors/anchor_ious_pl:0' shape=(?,) dtype=float32>: 
        <tf.Tensor 'pl_anchors/anchor_offsets_pl:0' shape=(?, 6) dtype=float32>: 
        <tf.Tensor 'pl_anchors/anchor_classes_pl:0' shape=(?,) dtype=float32>: 
        <tf.Tensor 'pl_anchors/bev_anchor_projections/bev_anchors_norm_pl:0' shape=(?, 4) dtype=float32>: 
        <tf.Tensor 'pl_anchors/img_anchor_projections/img_anchors_pl:0' shape=(?, 4) dtype=float32>:  
        <tf.Tensor 'pl_anchors/img_anchor_projections/img_anchors_norm_pl:0' shape=(?, 4) dtype=float32>: 
        <tf.Tensor 'pl_anchors/sample_info/frame_calib_p2:0' shape=(3, 4) dtype=float32>: 
        <tf.Tensor 'pl_anchors/sample_info/current_img_idx:0' shape=(1,) dtype=int32>: 
        <tf.Tensor 'pl_anchors/sample_info/ground_plane:0' shape=(4,) dtype=float32>: }
        """
