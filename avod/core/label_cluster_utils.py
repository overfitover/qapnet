...
class LabelClusterUtils:
    ...
    def _read_clusters_from_file(self, dataset, cls, num_clusters):
        ...
        #'/home/yxk/project/aa_demo_graduate/qapNet/avod/data/label_clusters/kitti/train/Car_2.txt'
    ...
    def get_clusters(self):
        ...
        classes = self._dataset.classes             # <class 'list'>: ['Car']
        num_clusters = self._dataset.num_clusters   # [2]
