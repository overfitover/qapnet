...
def project_to_bev(anchors, bev_extents):
    ...
    bev_x_extents_min = bev_extents[0][0]   # -40
    bev_z_extents_min = bev_extents[1][0]   # 0
    bev_x_extents_max = bev_extents[0][1]   # 40
    bev_z_extents_max = bev_extents[1][1]   # 70
    bev_x_extents_range = bev_x_extents_max - bev_x_extents_min   # 80
    bev_z_extents_range = bev_z_extents_max - bev_z_extents_min   # 70

    # 2D corners (top left, bottom right)
    x1 = x - half_dim_x  # 左
    x2 = x + half_dim_x  # 右
    # Flip z co-ordinates (origin changes from bottom left to top left)  翻转z坐标
    z1 = bev_z_extents_max - (z + half_dim_z)  # 上翻转到下
    z2 = bev_z_extents_max - (z - half_dim_z)  # 下翻转到上
    ...
    bev_extents_min_tiled = [bev_x_extents_min, bev_z_extents_min,
                             bev_x_extents_min, bev_z_extents_min]     # <class 'list'>: [-40.0, 0.0, -40.0, 0.0]
