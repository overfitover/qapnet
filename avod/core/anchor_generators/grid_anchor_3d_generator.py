...
def tile_anchors_3d(area_extents,
    ...
    Args:
        area_extents: [[min_x, max_x], [min_y, max_y], [min_z, max_z]]        [[-40.  40.][ -5.   3.][  0.  70.]]
        anchor_3d_sizes: list of 3d anchor sizes N x (l, w, h)                <class 'list'>: [array([ 3.513,  1.581,  1.511])
        anchor_stride: stride lengths (x_stride, z_stride)   图像坐标系是x y平面 [[ 0.5  0.5]]
        ground_plane: coefficients of the ground plane e.g. [0, -1, 0, 0]     [-0.04186422 -0.99912163  0.00183294  1.67556705]  planes的四个值
