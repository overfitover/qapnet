...
from Net.avod_model import AvodModel
...
def main(_):
    ...
    default_checkpoint_name = 'pyramid_people_example'
    default_data_split = 'val'
    default_ckpt_indices = [-1]
    ...
    # if len(sys.argv) == 1:          # 确定终端输入不止一个参数
    #     parser.print_help()
    #     sys.exit(1)
    ...
    model_config, _, eval_config, dataset_config = \
        config_builder.get_configs_from_pipeline_file(
            experiment_config_path, is_training=False)     # add path config
    # print("model_config: ", model_config)
    # print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
    # print("eval_config: ", eval_config)
    # print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
    # print("dataset_config: ", dataset_config)
    dataset_config.dataset_dir='/home/ovo/Kitti/object/drive_0064' # for video
    dataset_config.has_labels=False       # for video

    os.environ['CUDA_VISIBLE_DEVICES'] = args.device
    # print(args.ckpt_indices)
