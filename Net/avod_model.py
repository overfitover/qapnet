...
from Net.rpn_model import RpnModel
...
class AvodModel(model.DetectionModel):
    ...
    def create_feed_dict(self):
        ...
        """
        bev_input/bev_input_pl : (700, 800, 6)
        img_input/img_input_pl : (, , 3)
        pl_labels/label_anchors_pl : (, 6)
        pl_labels/label_boxes_3d_pl: (, 7)
        """
